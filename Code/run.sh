...
#Gradient boosting with car2vect NN# python Main.py --model_set DL --dataset_size full --ensemble_NN_flag 2 --loss_func mse --car_ident_flag 1 --no_neuron 1000 --no_neuron_embed 6000 --epoch 50 --num_regressor 10
...
#Retrain the model after removing outliers from total dataset with car2vect# python Main.py --model_set DL --dataset_size full --ensemble_NN_flag 7 --loss_func rel_err --car_ident_flag 1 --no_neuron 1000 --no_neuron_embed 6000 --epoch 50 --outliers_removal_percent 10

#######################
#Retrain the model after removing outliers from total dataset with car2vect, and apply Gradient Boosting# python Main.py --model_set DL --dataset_size full --ensemble_NN_flag 72 --loss_func rel_err --car_ident_flag 1 --no_neuron 1000 --no_neuron_embed 6000 --epoch 50 --outliers_removal_percent 1 --num_regressor 3
