...
#python Main.py --model_set DL --dataset_size full --ensemble_NN_flag 1 --loss_func mse --car_ident_flag 0 --no_neuron 1000 --no_hidden_layer 1 --epoch 30 --num_regressor 3
#python Main.py --model_set DL --dataset_size full --ensemble_NN_flag 2 --loss_func mse --car_ident_flag 1 --no_neuron 1000  --no_neuron_embed 6000 --epoch 30 --num_regressor 3
#python Main.py --model_set DL --dataset_size full --ensemble_NN_flag 3 --loss_func mse --car_ident_flag 0 --no_neuron 1000  --no_hidden_layer 2 --epoch 30 --num_regressor 3
