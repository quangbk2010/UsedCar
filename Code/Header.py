...
""" Features"""
if dataset_type == "old":
    features = ["maker_code","class_code","car_code","model_code","grade_code","year","vehicle_mile","cylinder_disp","rental_history","recovery_fee","views","option_sunLoop"]# Try to remove irrelevant features
