...
if dataset_type == "old":
    ...
    #features = ["maker_code","class_code","car_code","model_code","grade_code","car_type","year","trans_mode","fuel_type","vehicle_mile","cylinder_disp","tolerance_history","sale_history","rental_history","no_severe_accident","no_severe_water_accident","no_moderate_water_accident","total_no_accident","views","no_message_contact","no_call_contact","option_navigation","option_sunLoop","option_smartKey","option_xenonLight","option_heatLineSheet","option_ventilationSheet","option_rearSensor","option_curtainAirbag","no_cover_side_recovery","no_cover_side_exchange","no_corrosive_part","no_structure_exchange","recovery_fee","branch","affiliate_code","region","trading_complex","min_price","max_price","refund","vain_effort","guarantee","selected_color","mortgage","tax_unpaid","interest","reg_year","reg_month","year_diff","adv_month"] # 51 features, REMOVE: seller_id, trading_firm_id, input_color, ADD: adv_month,reg_year # NOTE: best until 2018-03-05
    #features = ["maker_code","class_code","car_code","model_code","grade_code","car_type","year","trans_mode","fuel_type","vehicle_mile","cylinder_disp","tolerance_history","sale_history","rental_history","no_severe_accident","no_severe_water_accident","no_moderate_water_accident","total_no_accident","views","no_message_contact","no_call_contact","option_navigation","option_sunLoop","option_smartKey","option_xenonLight","option_heatLineSheet","option_ventilationSheet","option_rearSensor","option_curtainAirbag","no_cover_side_recovery","no_cover_side_exchange","no_corrosive_part","no_structure_exchange","recovery_fee","branch","affiliate_code","region","trading_complex","min_price","max_price","refund","vain_effort","guarantee","selected_color","mortgage","tax_unpaid","interest","reg_year","reg_month","day_diff","adv_month"] # 51 features, SD prediction, REMOVE: seller_id, trading_firm_id, input_color, ADD: adv_month,reg_year # NOTE: best until 2018-03-05, replaced year_diff by day_diff in 2018-03-12
...
""" Using onehot or not"""
using_one_hot_flag = 0 # 1-yes, 0-no #####NOTE
