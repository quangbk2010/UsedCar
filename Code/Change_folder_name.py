...
parser.add_argument('--new_folder', type=str, default = 'saved_model_remove_price_smaller_200_bigger_9000_sortby_adv_date__car2vect_6000_1000')#_sampleRatio_50') # name of new folder
...
for i in range (num_regressors):
    ...
    bash_cmd += "rm full_*;"
    bash_cmd += "mv temp_save " + new_folder
    os.system (bash_cmd)
